...
if (isset($_POST['OK'])){ 
  ...
  $sub2=$_POST['sub2'];
	...
	$sql1="SELECT * FROM `studata` WHERE semester LIKE $sem1 AND department LIKE '%$dep1%' ";
	$sql2="SELECT * FROM `studata` WHERE department LIKE '%$dep2%' AND semester LIKE $sem2 ";
...
//--------------------------count total student---------------
          $countSQL1="SELECT COUNT( stu_name) as 'stud1' FROM studata WHERE department LIKE '%$dep1%' AND semester LIKE $sem1 ";
          $countRES1=mysqli_query($con, $countSQL1);
          $countdep1=mysqli_fetch_array($countRES1);
          $studep1=$countdep1['stud1'];
         
          
          $countSQL2="SELECT COUNT(name) as 'stud2' FROM studata WHERE department LIKE '%$dep2%' AND semester LIKE $sem2 ";
          $countRES2=mysqli_query($con, $countSQL2);
          $countdep2=mysqli_fetch_array($countRES2);
          $studep2=$countdep2['stud2'];

          $totalStu=$studep1+$studep2; //something error
